...
namespace Microsoft.WindowsAzure.Management.Compute
{
    ...
    internal partial class VirtualMachineVMImageOperations : IServiceOperations<ComputeManagementClient>, Microsoft.WindowsAzure.Management.Compute.IVirtualMachineVMImageOperations
    {
        ...
        /// request ID.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResponse> BeginCapturingAsync(string serviceName, string deploymentName, string virtualMachineName, VirtualMachineVMImageCaptureParameters parameters, CancellationToken cancellationToken)
        {
            // Validate
            if (serviceName == null)
            {
        ...
        /// </returns>
        public async System.Threading.Tasks.Task<Microsoft.WindowsAzure.Management.Compute.Models.ComputeOperationStatusResponse> CaptureAsync(string serviceName, string deploymentName, string virtualMachineName, VirtualMachineVMImageCaptureParameters parameters, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                cancellationToken.ThrowIfCancellationRequested();
                OperationResponse response = await client.VirtualMachineVMImages.BeginCapturingAsync(serviceName, deploymentName, virtualMachineName, parameters, cancellationToken).ConfigureAwait(false);
                cancellationToken.ThrowIfCancellationRequested();
        ...
        /// request ID.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResponse> DeleteAsync(string vmImageName, CancellationToken cancellationToken)
        {
            // Validate
            if (vmImageName == null)
            {
            ...
            // Construct URL
            string url = new Uri(this.Client.BaseUri, "/").ToString() + this.Client.Credentials.SubscriptionId + "/services/vmimages/" + vmImageName + "?comp=media";
        ...
        public async System.Threading.Tasks.Task<Microsoft.WindowsAzure.Management.Compute.Models.VirtualMachineVMImageListResponse> ListAsync(CancellationToken cancellationToken)
        {
            ...
            // Construct URL
            string url = new Uri(this.Client.BaseUri, "/").ToString() + this.Client.Credentials.SubscriptionId + "/services/vmimages";
